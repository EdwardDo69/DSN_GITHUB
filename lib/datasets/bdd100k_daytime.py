...
class bdd100k_daytime(imdb):
    def __init__(self, image_set, use_diff=False):
        imdb.__init__(self, "bdd100k" + "_daytime_" + image_set)
    ...
    def gt_roidb(self):
        ...
        """
        if not os.path.isdir("./data/cache/bdd100k_cache"):
            os.mkdir("./data/cache/bdd100k_cache")
