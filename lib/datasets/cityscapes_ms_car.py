...
class cityscapes_ms_car(imdb):
    def __init__(self, image_set, year="2007", devkit_path=None):
        imdb.__init__(self, "cityscape_ms_car" + year + "_" + image_set)
        self._year = year
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(
            self._data_path, "ImageSets", "Main", self._image_set + "_s.txt"
        )
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.cityscapes_KDA)
    ...
    def gt_roidb(self):
        ...
        """
        if not os.path.isdir("./data/cache/city_cache"):
            os.mkdir("./data/cache/city_cache")
        cache_file = os.path.join("./data/cache/city_cache", self.name + "_gt_roidb.pkl")
    ...
    def _load_pascal_annotation(self, index):
        ...
        filtered_car = [
            obj for obj in objs if obj.find('name').text == 'car'
        ]
        objs = filtered_car
