...
def parse_args():
  ...
  """
    ...
    parser.add_argument(
        "--cuda", dest="cuda", default=True, help="whether use CUDA", action="store_true"
    )
    parser.add_argument(
        "--ls",
        dest="large_scale",
...
if __name__ == "__main__":
    ...
    if args.dataset == "pascal_voc":
        ...
        args.s_imdbtest_name = "cityscape_for step in range(iters_per_epoch):2007_test_s"
    ...
    #for epoch in range(args.start_epoch, args.start_epoch+1):
        ...
        #for step in range(2):
            ...
            out_d_pixel_t1, out_d_t1, subnet1_base_feat2 = fasterRCNN(
                im_data,
                im_info,
                gt_boxes,
                num_boxes,
